export const en = {
  ...
  weekly_baseline_note: 'Weekly results are calculated from local analytics snapshots. After the first analytics visit, the app creates a baseline; exact 7-day deltas appear once enough data has been collected.',
  avg_label: 'Avg',
