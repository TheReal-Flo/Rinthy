export const ru = {
  ...
  weekly_baseline_note: 'Недельные итоги считаются по локальным снимкам статистики. После первого открытия аналитики приложение создаёт базовую точку, а точные 7-дневные дельты появятся после накопления данных.',
  avg_label: 'Среднее',
